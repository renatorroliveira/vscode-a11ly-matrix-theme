...
const EDITOR_PAIRS: readonly ContrastPair[] = [
    ...
    mark('tree.indentGuidesStroke', SIDEBAR, 'Tree indent guides'),
    mark('tree.inactiveIndentGuidesStroke', SIDEBAR, 'Inactive tree indent guides'),
    ui('extensionIcon.privateForeground', SIDEBAR, 'Private extension icon'),
    ui('extensionButton.separator', SIDEBAR, 'Extension button separator'),
    mark('textSeparator.foreground', SIDEBAR, 'Text separators'),
    dimmed('testing.iconSkipped.retired', SIDEBAR, 'Retired skipped test icon'),
    dimmed('testing.iconUnset.retired', SIDEBAR, 'Retired unset test icon'),
    ui('scmGraph.foreground1', SIDEBAR, 'SCM graph lane 1'),
    ui('scmGraph.foreground2', SIDEBAR, 'SCM graph lane 2'),
    ui('scmGraph.foreground3', SIDEBAR, 'SCM graph lane 3'),
    ui('scmGraph.foreground4', SIDEBAR, 'SCM graph lane 4'),
    ui('scmGraph.foreground5', SIDEBAR, 'SCM graph lane 5'),
    ...
    text('editorGutter.itemGlyphForeground', 'editorGutter.itemBackground', 'Gutter item glyph', EDITOR),
    mark('editorGutter.commentRangeForeground', EDITOR, 'Gutter comment range bar'),
    ui('editorGutter.commentGlyphForeground', 'editorGutter.commentRangeForeground', 'Gutter comment glyph'),
    ui('editorGutter.commentDraftGlyphForeground', 'editorGutter.commentRangeForeground', 'Gutter draft comment glyph'),
    ui(
        'editorGutter.commentUnresolvedGlyphForeground',
        'editorGutter.commentRangeForeground',
        'Gutter unresolved comment glyph',
    ),
    mark('editorOverviewRuler.addedForeground', EDITOR, 'Overview ruler added marks'),
    mark('editorOverviewRuler.modifiedForeground', EDITOR, 'Overview ruler modified marks'),
    mark('editorOverviewRuler.deletedForeground', EDITOR, 'Overview ruler deleted marks'),
    mark('editorOverviewRuler.rangeHighlightForeground', EDITOR, 'Overview ruler range highlight marks'),
    mark('editorOverviewRuler.border', EDITOR, 'Overview ruler border'),
    mark('terminalOverviewRuler.border', EDITOR, 'Terminal overview ruler border'),
    mark('terminalOverviewRuler.findMatchForeground', EDITOR, 'Terminal overview ruler find match marks'),
    ui('chart.line', EDITOR, 'Chat chart line'),
...
const WIDGET_PAIRS: readonly ContrastPair[] = [
    ...
    ui('editorSuggestWidget.focusOutline', 'editorSuggestWidget.selectedBackground', 'Suggest selected row outline'),
    ui('editorSuggestWidget.selectedIconForeground', 'editorSuggestWidget.selectedBackground', 'Suggest selected icon'),
    text(
        'editorSuggestWidget.focusHighlightForeground',
        'editorSuggestWidget.selectedBackground',
        'Suggest selected row match highlight',
    ),
    ui('notifications.border', 'notifications.background', 'Notification separators'),
...
const CONTROL_PAIRS: readonly ContrastPair[] = [
    ...
    dimmed('checkbox.disabled.foreground', 'checkbox.disabled.background', 'Disabled checkbox mark'),
    dimmed('checkbox.disabled.background', EDITOR, 'Disabled checkbox fill'),
    ui('radio.inactiveBorder', EDITOR, 'Unselected radio border'),
    ui('button.separator', 'button.background', 'Button separator'),
...
const TERMINAL_PAIRS: readonly ContrastPair[] = [
    ...
    text('terminal.ansiRed', 'terminalStickyScrollHover.background', 'Hovered sticky scroll in ANSI red', EDITOR),
    text('terminal.ansiGreen', 'terminalStickyScrollHover.background', 'Hovered sticky scroll in ANSI green', EDITOR),
    text('terminal.ansiYellow', 'terminalStickyScrollHover.background', 'Hovered sticky scroll in ANSI yellow', EDITOR),
    text('terminal.ansiBlue', 'terminalStickyScrollHover.background', 'Hovered sticky scroll in ANSI blue', EDITOR),
    text(
        'terminal.ansiMagenta',
        'terminalStickyScrollHover.background',
        'Hovered sticky scroll in ANSI magenta',
        EDITOR,
    ),
    text('terminal.ansiCyan', 'terminalStickyScrollHover.background', 'Hovered sticky scroll in ANSI cyan', EDITOR),
    text(
        'terminal.ansiBrightBlack',
        'terminalStickyScrollHover.background',
        'Hovered sticky scroll in ANSI brightblack',
        EDITOR,
    ),
];
...
export const DISTINGUISHABLE_GROUPS: Readonly<Record<string, readonly string[]>> = {
    ...
    focusVersusActive: ['focusBorder', 'contrastActiveBorder'],
