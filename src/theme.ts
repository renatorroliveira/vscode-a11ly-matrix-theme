...
export const THEME_LABEL = 'A11y Matrix Dark';

/** Output file name under `themes/`, referenced by `package.json`. */
export const THEME_FILE_NAME = 'a11y-matrix-dark-color-theme.json';

/** The assembled A11y Matrix Dark color theme document. */
